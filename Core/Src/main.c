...
/* Definitions for Smoke_detection */
osThreadId_t Smoke_detectionHandle;
const osThreadAttr_t Smoke_detection_attributes = {
...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* creation of Smoke_detection */
  Smoke_detectionHandle = osThreadNew(StartSmokeTask, NULL, &Smoke_detection_attributes);

  /* creation of TempTask */
  TempTaskHandle = osThreadNew(StartTempTask, NULL, &TempTask_attributes);

  /* creation of ProcessTask */
  ProcessTaskHandle = osThreadNew(StartTask03, NULL, &ProcessTask_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(temp_out_GPIO_Port, temp_out_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : Smoke_input_Pin */
  GPIO_InitStruct.Pin = Smoke_input_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(Smoke_input_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : temp_out_Pin */
...
/* USER CODE BEGIN Header_StartSmokeTask */
/**
  * @brief  Function implementing the Smoke_detection thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_StartSmokeTask */
void StartSmokeTask(void *argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
